...
const Header = () => {
  ...
  return (
    <header className="w-screen top-0 bg-orange-500 text-white py-2 sticky">
      <div className="w-full px-4 py-3 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-3 text-white">
          ...
          >
            <span
              className={`w-[30px] h-[3px] bg-white transition-all ${
            ...
            <span
              className={`w-[30px] h-[3px] bg-white transition-all ${
                isOpen ? "-rotate-45 translate-x-[8px] -translate-y-[8px]" : ""
              }`}
            ></span>
          </button>
        </nav>
